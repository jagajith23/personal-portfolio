...
function MaskedReveal({
  ...
  return (
    <h1
      className="text-3xl font-semibold tracking-[0.08em] text-gray-100 md:text-6xl flex gap-3 md:gap-5"
    ...
    >
      ...
      {accent && (
        <motion.span
          ...
          className="text-signature inline-block self-end mb-3 md:mb-5"
        >
          <motion.div
            animate={{
              boxShadow: [
            ...
            className="w-2 h-2 md:w-3 md:h-3 bg-signature rounded-full"
          />
        </motion.span>
      )}
    </h1>
...
function MagneticSocialLink({
  ...
  const hoverColor = design === "brutal" && brutalColor ? brutalColor : color;
