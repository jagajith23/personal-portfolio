...
export const CAREER = [
  {
    ...
    bullets: [
      "Served as the primary point of contact for a company-wide modernization program, resolving cross-team and vendor queries within 1–2 days and reviewing the majority of pull requests to uphold code quality and architectural consistency.",
      "Redesigned the Offer and Auction database schemas and unified a previously fragmented Offer Service into one, eliminating data duplication and simplifying integration for downstream teams.",
      "Built the end-to-end offer lifecycle — approval/rejection, counter-offer, renegotiation, contract execution, and e-sign — behind a role-based Offers API.",
      ...
      "Developed a responsive, mobile-friendly dashboard with real-time WebSocket updates, and improved Core Web Vitals (LCP, CLS, INP, FID) through load-time and rendering optimizations.",
        ...
        <span className="relative flex h-4 w-4 items-center justify-center">
          ...
          <span
            className={`relative h-3 w-3 rounded-full ring-4 ring-black transition-colors ${
              isPresent || isActive ? "bg-zinc-100" : "bg-zinc-600"
            }`}
          />
        </span>
      </motion.span>
