...
export default function Page({ params }: { params: Promise<{ id: number }> }) {
    ...
    if (!project) {
        return (
            <div className="min-h-screen bg-black flex items-center justify-center text-zinc-400 font-aoboshi">
                Project not found
            </div>
        );
    }
            ...
            <main className="max-w-7xl mx-auto px-6 md:px-12 pt-32 pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <motion.div
                        ...
                        className="lg:col-span-2 h-100 lg:h-125 relative rounded-2xl overflow-hidden group"
                    >
                        <Image
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        variants={staggerContainer}
                        className="lg:col-span-1 min-h-100 lg:h-125 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 flex flex-col justify-center"
                    >
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        {prevProject ? (
                            <Link
                                ...
                                onMouseEnter={() =>
                                    setPrevHoverColor(
                                        getRandomColor(prevHoverColor),
                                    )
                                }
                                onMouseLeave={() =>
                                    setPrevHoverColor("text-white")
                                }
                            >
                                <motion.div
                                    ...
                                    initial="rest"
                                >
                                    <div className="flex items-center gap-2 text-zinc-400 group-hover:text-zinc-300 transition-colors text-sm uppercase tracking-wider font-medium">
                                        <motion.svg
                                            width="16"
                                            height="16"
                                            viewBox="0 0 24 24"
                        ...
                        {nextProject ? (
                            <Link
                                ...
                                onMouseEnter={() =>
                                    setNextHoverColor(
                                        getRandomColor(nextHoverColor),
                                    )
                                }
                                onMouseLeave={() =>
                                    setNextHoverColor("text-white")
                                }
                            >
                                <motion.div
